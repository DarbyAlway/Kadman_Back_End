...
@patch("routes.vendors.notify_vendor")
@patch("routes.vendors.update_layout")
@patch("routes.vendors.update_vendor_attendance_days")
@patch("routes.vendors.update_vendor_attendance")
@patch("routes.vendors.get_vendor_by_lineid")
@patch("routes.vendors.get_db_connection")
