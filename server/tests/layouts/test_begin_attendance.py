...
def test_begin_attendance_success(client):
    ...
    with patch("routes.layouts.get_db_connection", return_value=mock_conn), \
         patch("routes.layouts.send_line_multicast", return_value=(200, "OK")), \
         patch("routes.layouts.change_all_status_to_pending_attendance") as mock_change, \
         patch("routes.layouts.activate_layout_status") as mock_activate:
